    ...
    if (member.memberId !== "" && member.memberPw !== "") {
      ...
      axios
        ...
        .then((res) => {
          ...
          if (res.data.banCnt >= 1) {
            Swal.fire({
              title: "이용 제한 계정",
              html: `사용자 계정은 사용이 제한된 계정입니다.<br/>정지 시작 : ${res.data.memberBenStartDate}<br/>정지 종료 : ${res.data.memberBenFinishDate}<br/>정지 사유 : ${res.data.memberBanContent}`,
              icon: "warning",
            });
          } else {
